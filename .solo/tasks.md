...
- [x] T27: Exercised the root CI through PR #3. Run `31202163401` completed successfully: website typecheck/lint/build/test, read-only agent-platform structural/license/link/doc-freshness/graph validation, and the portable dependency + remediation security gate all passed. This supersedes the earlier pre-PR note that CI had never executed.  (feature: release)
