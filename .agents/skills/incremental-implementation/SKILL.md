...
description: Delivers changes incrementally. Use when implementing any feature or change that touches more than one file. Use when you're about to write a large amount of code at once, or when a task feels too big to land in one step. Activate for the stated use cases. Do not activate for unrelated work or when a narrower repository skill owns the task.
---
