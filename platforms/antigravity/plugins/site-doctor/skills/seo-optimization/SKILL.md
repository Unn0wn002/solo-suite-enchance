...
description: Generalist SEO pass inside a site-doctor health audit - meta tags and headings, indexation smoke checks, structured-data presence, and the SEO half of Core Web Vitals. Use when SEO comes up during a broader website audit, or when the dedicated seo plugin is NOT installed. Do NOT use when the seo plugin is available and the request is specialist or full-site - defer schema markup to seo-schema, XML sitemaps to seo-sitemap, hreflang/i18n to seo-hreflang, GEO/AEO and AI-search visibility to seo-geo, deep crawlability and Core Web Vitals to seo-technical, a single URL to seo-page, and a scored full-site audit to the seo orchestrator.
---
