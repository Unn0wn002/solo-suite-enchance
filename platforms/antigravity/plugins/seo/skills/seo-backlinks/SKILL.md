...
- Fetch the target site (via `${CLAUDE_PLUGIN_ROOT}/lib/url_guard.py`-guarded requests) and review on-page evidence of link relationships — testimonial/partner pages, embedded badges, syndication credits.
