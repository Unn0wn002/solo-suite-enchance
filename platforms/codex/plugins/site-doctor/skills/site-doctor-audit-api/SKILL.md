---
name: site-doctor-audit-api
description: "Audit a REST or GraphQL API for security, design, and reliability Use when the user explicitly invokes $site-doctor-audit-api or asks for this site-doctor audit-api workflow."
---
...
Use $api-audit on the user's supplied arguments and surrounding request.
