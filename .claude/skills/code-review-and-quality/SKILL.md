...
description: Conducts multi-axis code review. Use before merging any change. Use when reviewing code written by yourself, another agent, or a human. Use when you need to assess code quality across multiple dimensions before it enters the main branch. Activate for the stated use cases. Do not activate for unrelated work or when a narrower repository skill owns the task.
---
